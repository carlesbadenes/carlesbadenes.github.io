...
| ![Plot from Badenes et al. (2018)](/images/Badenes18DRVmax.png) |<b>Main sequence stars and Red Giants</b>: Thanks to the excellent spectral resolution of the [APOGEE](https://www.sdss.org/dr15/irspec/) IR spectrographs in SDSS, we have been able to conduct a systematic exploration of the fundamental statistics of stellar multiplicity and their dependance on stellar properties. We found that there is a complex relationship between the close binary fraction (the fraction of stars with binary companions in periods of a few years or less) and the chemical composition of stars ([Mazzola Daher et al. 2022](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.2051D/)). We found a strong anti-correlation between close binary fraction and metallicity: see [Badenes et al. 2018](https://ui.adsabs.harvard.edu/abs/2018ApJ...854..147B/) (this paper was featured in [astrobites](https://astrobites.org/2017/11/23/how-many-stars-have-companions/)) and [Moe, Kratter, and Badenes 2019](https://ui.adsabs.harvard.edu/abs/2019ApJ...875...61M/). Stellar rotation also appears to be strongly correlated with the close binary fraction ([Mazzola Daher et al. 2022](https://ui.adsabs.harvard.edu/abs/2022MNRAS.512.2051D/)). |
